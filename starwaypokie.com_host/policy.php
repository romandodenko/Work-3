...
?>
    <main>
      <section class="terms">
        <div class="container">
          <h1>Privacy Policy for starwaypokie.com</h1>

          <p>At starwaypokie.com, accessible from starwaypokie.com, one of our main priorities is the privacy of our
            visitors. This Privacy Policy document contains types of information that is collected and recorded by
            starwaypokie.com and how we use it.</p>
          ...
          <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
            regards to the information that they shared and/or collect in starwaypokie.com. This policy is not
          ...
          <p>starwaypokie.com follows a standard procedure of using log files. These files log visitors when they visit
          ...
          <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
            used in their respective advertisements and links that appear on starwaypokie.com, which are sent directly
          ...
          <p>Note that starwaypokie.com has no access to or control over these cookies that are used by third-party
            advertisers.</p>

          <h2>Third Party Privacy Policies</h2>

          <p>starwaypokie.com's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
          ...
          <p>starwaypokie.com does not knowingly collect any Personal Identifiable Information from children under the
