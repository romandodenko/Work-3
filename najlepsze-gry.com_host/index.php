        ...
        <div class="poncher__container container">
          <div class="poncher__descr">
            ...
            <p class="poncher__text">
              Aby zacząć grać w gry za darmo, gracz powinien wybrać witrynę. Następnie musisz zapoznać się z ogólnymi
              informacjami na portalu i zdecydować o rodzaju urządzenia.
            </p>
            <div class="poncher__item">
              <p class="poncher__text">
                Po wybraniu gry pozostaje nacisnąć klawisz PLAY. Aby gra rozpoczęła się bez problemów. Rozgrywka w
                trybie swobodnym odbywa się na wirtualnych kredytach, które nadawane są przez administrację klubu. Jeśli
                depozyt wyniesie zero, należy odświeżyć stronę, a pieniądze zostaną ponownie zaksięgowane. Urządzenia w
                darmowej wersji wizualnie niczym nie różnią się od płatnych modeli. Nie wymagają rejestracji ani
                potwierdzenia SMS-em. W dowolnym momencie możesz grać w trybie nieograniczonym.
              </p>
            </div>
          </div>
