          ...
          <section class="terms">
            <div class="terms__container container">
              <div class="terms__column">
                <h1>Privacy Policy for cool-pokies-au.com</h1>

                <p>At cool-pokies-au.com, accessible from cool-pokies-au.com, one of our main priorities is the privacy
                  of our visitors. This Privacy Policy document contains types of information that is collected and
                  recorded by cool-pokies-au.com and how we use it.</p>

                <p>If you have additional questions or require more information about our Privacy Policy, do not
                  hesitate to contact us.</p>

                <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website
                  with regards to the information that they shared and/or collect in cool-pokies-au.com. This policy is
                ...
                <p>cool-pokies-au.com follows a standard procedure of using log files. These files log visitors when
                ...
                <P>You may consult this list to find the Privacy Policy for each of the advertising partners of
                  cool-pokies-au.com.</p>

              </div>
              <div class="terms__column">
                <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                  are used in their respective advertisements and links that appear on cool-pokies-au.com, which are
                ...
                <p>Note that cool-pokies-au.com has no access to or control over these cookies that are used by
                  third-party advertisers.</p>

                <h2>Third Party Privacy Policies</h2>

                <p>cool-pokies-au.com's Privacy Policy does not apply to other advertisers or websites. Thus, we are
