    ...
    <section class="terms">
      <div class="terms__container container">
        <div class="terms__column">
          ...
          <p>Welcome to cool-pokies-au.com!</p>

          <p>These terms and conditions outline the rules and regulations for the use of cool-pokies-au.com's
            Website, located at cool-pokies-au.com.</p>

          <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
            cool-pokies-au.com if you do not agree to take all of the terms and conditions stated on this page.
          </p>
          ...
          <p>We employ the use of cookies. By accessing cool-pokies-au.com, you agreed to use cookies in agreement
            with the cool-pokies-au.com's Privacy Policy. </p>
          ...
          <p>Unless otherwise stated, cool-pokies-au.com and/or its licensors own the intellectual property rights
            for all material on cool-pokies-au.com. All intellectual property rights are reserved. You may access
            this from cool-pokies-au.com for your own personal use subjected to restrictions set in these terms
            and conditions.</p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from cool-pokies-au.com</li>
            <li>Sell, rent or sub-license material from cool-pokies-au.com</li>
            <li>Reproduce, duplicate or copy material from cool-pokies-au.com</li>
            <li>Redistribute content from cool-pokies-au.com</li>
          </ul>

          <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
            certain areas of the website. cool-pokies-au.com does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the views and opinions of
            cool-pokies-au.com,its agents and/or affiliates. Comments reflect the views and opinions of the person
            who post their views and opinions. To the extent permitted by applicable laws, cool-pokies-au.com
            shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered
            as a result of any use of and/or posting of and/or appearance of the Comments on this website.</p>

          <p>cool-pokies-au.com reserves the right to monitor all Comments and to remove any Comments which can be
          ...
          <p>You hereby grant cool-pokies-au.com a non-exclusive license to use, reproduce, edit and authorize
        ...
        <div class="terms__column">
          ...
          <p>We will approve link requests from these organizations if we decide that: (a) the link would not make
            ...
            the absence of cool-pokies-au.com; and (d) the link is in the context of general resource information.
          </p>
          ...
          <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
            website, you must inform us by sending an e-mail to cool-pokies-au.com. Please include your name, your
          ...
          <p>No use of cool-pokies-au.com's logo or other artwork will be allowed for linking absent a trademark
            license agreement.</p>
