      ...
      <section class="ibiot" id="about">
        <div class="container">
          ...
          <p class="ibiot__text">
            ...
            Stawiamy na prawdziwe gry tworzone przez najlepszych producentów gier. Możesz grać w zupełnie nowe gry bez
            wydawania prawdziwych pieniędzy. Nie jest wymagana wpłata ani rejestracja, są to gry na prawdziwe pieniądze,
            w które możesz grać za darmo.
          </p>
          <p class="ibiot__text">
            Jeśli jesteś początkującym, jest to świetny sposób na poznanie zasad i zaznajomienie się z oprogramowaniem
            do gry bez ryzykowania pieniędzy. Możesz wypróbować nowe gry, w które nigdy wcześniej nie grałeś i nie
            chcesz ryzykować swojego bankrolla.
          </p>
