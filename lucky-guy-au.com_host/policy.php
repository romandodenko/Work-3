...
?>
    <main>
      <section class="terms">
        <div class="container">
          <h1>Privacy Policy for lucky-guy-au.com</h1>

          <p>At lucky-guy-au.com, accessible from lucky-guy-au.com, one of our main priorities is the privacy of our
            visitors. This Privacy Policy document contains types of information that is collected and recorded by
            lucky-guy-au.com and how we use it.</p>
          ...
          <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
            regards to the information that they shared and/or collect in lucky-guy-au.com. This policy is not
          ...
          <p>lucky-guy-au.com follows a standard procedure of using log files. These files log visitors when they visit
          ...
          <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
            used in their respective advertisements and links that appear on lucky-guy-au.com, which are sent directly
          ...
          <p>Note that lucky-guy-au.com has no access to or control over these cookies that are used by third-party
            advertisers.</p>

          <h2>Third Party Privacy Policies</h2>

          <p>lucky-guy-au.com's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
