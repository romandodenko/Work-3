    ...
    <header class="header">
      <div class="header__container container">
        ...
        <div class="header__menu">
          <a class="header__logo header__logo_menu" href="main.php"><img src="./img/logo.svg" alt="Logo"></a>
          <nav class="nav">
            <ul class="nav__list">
              <li class="nav__item">
        ...
        <a class="header__logo" href="main.php"><img src="./img/logo.svg" alt="Logo"></a>
      </div>
    </header>