...
?>
    <main>
      <section class="terms">
        <div class="container">
          <h1>Privacy Policy for legalpokies-au.com</h1>

          <p>At legalpokies-au.com, accessible from legalpokies-au.com, one of our main priorities is the privacy of our
            visitors. This Privacy Policy document contains types of information that is collected and recorded by
            legalpokies-au.com and how we use it.</p>
          ...
          <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
            regards to the information that they shared and/or collect in legalpokies-au.com. This policy is not
          ...
          <p>legalpokies-au.com follows a standard procedure of using log files. These files log visitors when they
          ...
          <P>You may consult this list to find the Privacy Policy for each of the advertising partners of
            legalpokies-au.com.</p>

          <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
            used in their respective advertisements and links that appear on legalpokies-au.com, which are sent directly
          ...
          <p>Note that legalpokies-au.com has no access to or control over these cookies that are used by third-party
            advertisers.</p>

          <h2>Third Party Privacy Policies</h2>

          <p>legalpokies-au.com's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
          ...
          <p>legalpokies-au.com does not knowingly collect any Personal Identifiable Information from children under the
