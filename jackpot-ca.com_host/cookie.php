...
?>
      <div class="page__bottom">
        <main>
          <section class="terms">
            <div class="container">
              <h1>Cookie Policy for jackpot-ca.com</h1>

              <p>This is the Cookie Policy for jackpot-ca.com, accessible from jackpot-ca.com</p>
              ...
              <ul>
                ...
                <li>
                  <p>We use adverts to offset the costs of running this site and provide funding for further
                    development. The behavioural advertising cookies used by this site are designed to ensure that we
                    provide you with the most relevant adverts where possible by anonymously tracking your interests and
                    presenting similar things that may be of interest.</p>
                </li>
